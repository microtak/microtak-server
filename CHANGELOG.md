...
* **deploy:** make docker-compose ports/domain configurable via .env ([d35f4c8](https://github.com/microtak/microtak-server/commit/d35f4c848a12fed35973283ad5511fa70bb15fc2))
* **enrollment:** add opt-in enrollment invite tokens and admin API ([affcc6c](https://github.com/microtak/microtak-server/commit/affcc6c892fd075be919700fbcbeb5a835b194db))
* **enrollment:** switch enrollment gating to Auto/Open, secure by default ([669a894](https://github.com/microtak/microtak-server/commit/669a89421940839fdd3e44a76a5ad5d05363d910))
...
* **missions:** add MISSION_OWNER/SUBSCRIBER-style roles ([c7018d2](https://github.com/microtak/microtak-server/commit/c7018d27cfa6d3c7c92b6f7dc0e38aef86de6f0f))
* **nix:** add flake.nix with a NixOS module ([530292c](https://github.com/microtak/microtak-server/commit/530292c6b080b8a26f22eef431f8ba30bbc041cd))
...
* real TAK-Server/CloudTAK wire compatibility (OAuth login, discovery endpoints) ([0f3bbf5](https://github.com/microtak/microtak-server/commit/0f3bbf53d8b6efcc4304dc6596a2043d94e91d8b))
...
* **ci:** chain Docker publish from release-please via workflow_call ([1bed781](https://github.com/microtak/microtak-server/commit/1bed781c4011f00b0777aa5047690fa4c819a692))
...
* add the MicroTAK ecosystem packaging plan (apt, Nix, AUR) ([e4d0b04](https://github.com/microtak/microtak-server/commit/e4d0b04d659542bb6a85d8005fa05b0a68a65b49))
...
* **readme:** add system requirements section ([5a72ab5](https://github.com/microtak/microtak-server/commit/5a72ab533822462643a7c0cb13c6d30d5b4b2535))
* **readme:** rewrite for humans, not as a status log ([3e474fd](https://github.com/microtak/microtak-server/commit/3e474fd8527d37d397029f7c8a992592a9e98336))
...
* record enrollment lockdown / admin API design and test catalog ([e25a400](https://github.com/microtak/microtak-server/commit/e25a400366baf0346e8b98b3c1dde125bcd08095))
* record measured resource requirements (100 clients, Pi Zero) ([4efa74c](https://github.com/microtak/microtak-server/commit/4efa74c23eba17e81753910e2f0c0bf92fa5e853))
...
* record mission roles (Owner/Subscriber) design and test catalog ([a4aa3b8](https://github.com/microtak/microtak-server/commit/a4aa3b8460d5a4dda3f4a101f82da58634fdf9ce))
...
* **ci:** chain Docker publish from release-please via workflow_call ([e81bf14](https://github.com/microtak/microtak-server/commit/e81bf1409b8eefc4c7d9958db1883aa6a902fac8))
* **transport:** share one broadcast bus between plain-TCP and mTLS relays ([95a076d](https://github.com/microtak/microtak-server/commit/95a076d5dbc87d3829b4854a3111ffdc22e382d9))
